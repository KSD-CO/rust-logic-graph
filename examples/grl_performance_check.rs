...
fn main() {
    ...
    println!("\n  Average parse time: {:.3} ms", avg_parse_time.as_secs_f64() * 1000.0);
    ...
    println!("  ... (10 samples)");
    println!("  Average parse time: {:.3} ms\n", avg_simple.as_secs_f64() * 1000.0);
    ...
    println!("{}", "═".repeat(50));
    println!("  GRL Parse (purchasing rules): {:.3} ms", avg_parse_time.as_secs_f64() * 1000.0);
    println!("  GRL Parse (simple rule):      {:.3} ms", avg_simple.as_secs_f64() * 1000.0);
    println!("  Rule Execution:               {:.3} ms", avg_exec.as_secs_f64() * 1000.0);
